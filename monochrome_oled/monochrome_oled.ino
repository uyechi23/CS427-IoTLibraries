...
// Declaration for an SSD1306 display connected to I2C (SDA, SCK pins)
// The pins for I2C are defined by the Wire-library. 
// On an arduino UNO:       A4(SDA), A5(SCK)
// On an arduino MEGA 2560: 20(SDA), 21(SCK)
// On an arduino LEONARDO:   2(SDA),  3(SCK), ...
